...
if ( ! function_exists( 'my_simple_theme_setup' ) ) :
	...
	function my_simple_theme_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'my-simple-theme' ),
		) );
...
function my_simple_theme_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'my_simple_theme_content_width', 640 );
}
...
function my_simple_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'my-simple-theme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'my-simple-theme' ),
...
function my_simple_theme_scripts() {
	...
	wp_enqueue_script( 'my-simple-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'my-simple-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
